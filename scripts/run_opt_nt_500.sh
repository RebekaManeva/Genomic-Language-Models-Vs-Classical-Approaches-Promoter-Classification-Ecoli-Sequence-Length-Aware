#!/bin/bash
#SBATCH --job-name=opt_nt_500
#SBATCH --partition=openlab-queue
#SBATCH --gres=gpu:1
#SBATCH --cpus-per-task=8
#SBATCH --mem=32G
#SBATCH --time=08:00:00
#SBATCH --output=/home/hpc/users/ml_models/rebeka.maneva/nlp/logs/opt_nt_500_%j.out
#SBATCH --error=/home/hpc/users/ml_models/rebeka.maneva/nlp/logs/opt_nt_500_%j.err

# =============================================================================
# Bayesian optimization (Optuna) — Nucleotide Transformer v2 100M, 500 bp
# =============================================================================
...
echo "Starting NT 500bp optimization — $(date)"
...
python3 ${OPT_DIR}/optimize_hf_seqclf.py \
  ...
  --trust-remote-code \
  --study-name          nt_500bp_opt \
  --storage             sqlite:///${OUT_DIR}/study.db

echo "Finished NT 500bp optimization — $(date)"
