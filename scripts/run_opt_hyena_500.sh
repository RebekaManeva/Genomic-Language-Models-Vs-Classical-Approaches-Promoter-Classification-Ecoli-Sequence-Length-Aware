#!/bin/bash
#SBATCH --job-name=opt_hyena_500
#SBATCH --partition=openlab-queue
#SBATCH --gres=gpu:1
#SBATCH --cpus-per-task=8
#SBATCH --mem=32G
#SBATCH --time=08:00:00
#SBATCH --output=/home/hpc/users/ml_models/rebeka.maneva/nlp/logs/opt_hyena_500_%j.out
#SBATCH --error=/home/hpc/users/ml_models/rebeka.maneva/nlp/logs/opt_hyena_500_%j.err

# =============================================================================
# Bayesian optimization (Optuna) — HyenaDNA tiny-16k-d128, 500 bp sequences
# =============================================================================
...
echo "Starting HyenaDNA 500bp optimization — $(date)"
...
python3 ${OPT_DIR}/optimize_hf_seqclf.py \
  ...
  --trust-remote-code \
  --study-name          hyena_500bp_opt \
  --storage             sqlite:///${OUT_DIR}/study.db

echo "Finished HyenaDNA 500bp optimization — $(date)"
