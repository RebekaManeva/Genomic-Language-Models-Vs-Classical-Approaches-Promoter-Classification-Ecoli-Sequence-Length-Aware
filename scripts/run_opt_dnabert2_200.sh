#!/bin/bash
#SBATCH --job-name=opt_dnabert2_200
#SBATCH --partition=openlab-queue
#SBATCH --gres=gpu:1
#SBATCH --cpus-per-task=8
#SBATCH --mem=32G
#SBATCH --time=08:00:00
#SBATCH --output=/home/hpc/users/ml_models/rebeka.maneva/nlp/logs/opt_dnabert2_200_%j.out
#SBATCH --error=/home/hpc/users/ml_models/rebeka.maneva/nlp/logs/opt_dnabert2_200_%j.err
...
DATA_PATH=${PROJECT_DIR}/data/dnabert2_200
OUT_DIR=${PROJECT_DIR}/outputs/opt_dnabert2_200bp
...
echo "Starting DNABERT-2 200bp optimization — $(date)"
...
python3 ${OPT_DIR}/optimize_dnabert2.py \
  ...
  --kmer           -1 \
  --fp16 \
  --study-name     dnabert2_200bp_opt \
  --storage        sqlite:///${OUT_DIR}/study.db

echo "Finished DNABERT-2 200bp optimization — $(date)"
